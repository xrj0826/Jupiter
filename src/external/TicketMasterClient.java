...
public class TicketMasterClient {
	...
	private static final String API_KEY = "1FOAX054gTeZCGmR4oO51nJN0E8jnNXv";
	...
	//main function
	//输入经纬度坐标，通过API将数据查到。用bufferReader读取，转成String。再转成Json，
	//把Json中每一个event转成item object，存到set中
